...
pushd $app_path${KF_APP}/ks_app/
ks param set notebooks pvcMount "/home/jovyan/storage/"
ks param set jupyter useJupyterLabAsDefault true
ks apply default
popd
